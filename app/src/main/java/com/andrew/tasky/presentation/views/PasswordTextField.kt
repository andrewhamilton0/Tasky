...
class PasswordTextField @JvmOverloads constructor(
    ...
    fun isPasswordValid(): Boolean{
        return if(PasswordValidator().validate(binding.passwordEditText.text.toString())){
            ...
            Toast.makeText(context, String.format(resources.getString(R.string.error_invalid_password_format), PasswordValidator.MIN_PASSWORD_LENGTH), Toast.LENGTH_LONG).show()
            false
        }
    }
}